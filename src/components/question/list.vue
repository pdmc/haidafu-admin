    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="pkuser__nickName" label="提问人" sortable width="100">
                </el-table-column>
                <el-table-column prop="pkuser__avatarUrl" label="头像" width="80">
                ...
                <el-table-column prop="labels" label="标签" sortable width="120">
                </el-table-column>
                <el-table-column prop="ansNum" label="回复数" sortable width="80">
                </el-table-column>
                <el-table-column prop="stateName" label="状态" sortable width="70" class="red">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="createTime" label="提问时间" sortable width="100">
                </el-table-column>
                <el-table-column label="操作" width="140" align="center">
                    <template slot-scope="scope">
                        ...
                        <!--el-button type="text" icon="el-icon-edit" v-if="tableData[scope.$index].state==0" @click="handleUnpass(scope.$index, scope.row)">不通过</el-button>
                        <p v-if="tableData[scope.$index].state!=0">已编辑</p>
