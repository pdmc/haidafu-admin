    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                this.$axios.get('https://bhost.pk4yo.com/myactivity', {
                    page: this.cur_page
                }).then((res) => {
            ...
            saveEdit() {
            	...
            	this.$axios.get('https://bhost.pk4yo.com/myactivity/update', {
                    params: this.form
                }).then((res) => {
            ...
            // 确定删除
            deleteRow(){
            	this.$axios.get('https://bhost.pk4yo.com/myactivity/delete', {
