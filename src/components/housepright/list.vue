    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>产权年限</el-breadcrumb-item>
...
<script>
    export default {
        ...
        methods: {
            ...
            toAdd() {
            	this.$router.push({path: '/houseprightadd'});
            },
            delAll() {
            ...
            saveEdit() {
            	...
            	this.$axios.get('https://bhost.pk4yo.com/prights/update', {
                    params: this.form
                }).then((res) => {
            ...
            // 确定删除
            deleteRow(){
            	this.$axios.get('https://bhost.pk4yo.com/prights/delete', {
                    params: { prId: this.dbid }
                }).then((res) => {
                	if(res.status == 200 && res.data.code == 0){
